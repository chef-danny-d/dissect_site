# Official website and webapp of Dissect
  //Dissect's statement comes here// 
# Structure
  All the files included with Disscet are lsited below
```
|-- HTML
    |-- README.md
    |-- acc_nav.php
    ...
    |-- login
        ...
        |   |   |-- press-this-editor-rtl.min.css
        |   |   |-- press-this-editor.css
        |   |   |-- press-this-editor.min.css
        |   |   |-- press-this-rtl.css
        ...
        |   |       |-- languages
        |   |       |   |-- contact-form-7-af.mo
        |   |       |   |-- contact-form-7-ar.mo
        |   |       |   |-- contact-form-7-bel.mo
        |   |       |   |-- contact-form-7-bg_BG.mo
        |   |       |   |-- contact-form-7-bn_BD.mo
        |   |       |   |-- contact-form-7-bn_IN.mo
        |   |       |   |-- contact-form-7-bs_BA.mo
        |   |       |   |-- contact-form-7-ca.mo
        |   |       |   |-- contact-form-7-ckb.mo
        |   |       |   |-- contact-form-7-el.mo
        |   |       |   |-- contact-form-7-eo.mo
        |   |       |   |-- contact-form-7-eu.mo
        |   |       |   |-- contact-form-7-fa_IR.mo
        |   |       |   |-- contact-form-7-ga.mo
        |   |       |   |-- contact-form-7-gl_ES.mo
        |   |       |   |-- contact-form-7-gu.mo
        |   |       |   |-- contact-form-7-he_IL.mo
        |   |       |   |-- contact-form-7-hi_IN.mo
        |   |       |   |-- contact-form-7-ht.mo
        |   |       |   |-- contact-form-7-hy.mo
        |   |       |   |-- contact-form-7-id_ID.mo
        |   |       |   |-- contact-form-7-ka_GE.mo
        |   |       |   |-- contact-form-7-ko_KR.mo
        |   |       |   |-- contact-form-7-lt_LT.mo
        |   |       |   |-- contact-form-7-lv.mo
        |   |       |   |-- contact-form-7-mk_MK.mo
        |   |       |   |-- contact-form-7-ml_IN.mo
        |   |       |   |-- contact-form-7-ms_MY.mo
        |   |       |   |-- contact-form-7-mt_MT.mo
        |   |       |   |-- contact-form-7-nb_NO.mo
        |   |       |   |-- contact-form-7-pa_IN.mo
        |   |       |   |-- contact-form-7-pt_BR.mo
        |   |       |   |-- contact-form-7-si_LK.mo
        |   |       |   |-- contact-form-7-sl_SI.mo
        |   |       |   |-- contact-form-7-sq.mo
        |   |       |   |-- contact-form-7-sr_RS.mo
        |   |       |   |-- contact-form-7-ta_IN.mo
        |   |       |   |-- contact-form-7-th.mo
        |   |       |   |-- contact-form-7-tl.mo
        |   |       |   |-- contact-form-7-uk.mo
        |   |       |   |-- contact-form-7-vi.mo
        |   |       |   |-- contact-form-7-zh_CN.mo
        |   |       |   |-- contact-form-7-zh_TW.mo
        |   |       |   |-- contact-form-7.pot
        |   |       |   |-- readme.txt
        |   |       |-- modules
        |   |           |-- acceptance.php

<nav id="acc_nav" class="navbar navbar-default hidden-xs">
  <div>
    ...
    <div class="navbar-header">
        <img src="../img/SynkMonster-Updated-Logo_V2_no-name.png" id="navimg" class="nor">
...
<nav class="navbar navbar-default visible-xs-block">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"><img src="../img/SynkMonster-Updated-Logo_V2_no-name.png"></a>
    </div>
